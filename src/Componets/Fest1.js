  ...
  return (
    ...
    maxWidth={{ base: "100vh", md: "130vh", xl:"130vh"}} >
      ...
      <Flex direction={isNotSmallerScreen ? "row" : "column"} mt={8} >
        ...
        <Box >
          <Image src='https://cdn.dribbble.com/users/1732368/screenshots/7840161/media/3a24bf58c1fd728b1e42ed14e9c78268.gif' alt='Diwali'  width="500px" height="229"/>
        </Box>
        <Text color="white" p='4' fontSize="xl" fontWeight="semibold">Play</Text>
        </Flex>
      </Flex>
      </Box>
